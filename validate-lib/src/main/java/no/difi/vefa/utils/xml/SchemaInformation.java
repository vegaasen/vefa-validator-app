...
public class SchemaInformation {
     ...
     * @throws Exception
     */
    public static Schema detectSchemaInformation(Document xmlDoc, Messages messages) throws Exception {
     ...
     * @throws Exception
     */
    private static String getIdentifier(Document xmlDoc, Messages messages) throws Exception {
        // Setup
     ...
     * @throws Exception
     */
    private static String getVersion(final String id, Messages messages) throws Exception {
        // Setup
