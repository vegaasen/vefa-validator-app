...
<xsl:stylesheet 
	...
	<xsl:variable name="supplierCompanyID" select="/*/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" />
	<xsl:variable name="customerCompanyID" select="/*/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID" />
